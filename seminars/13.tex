...
\eee
\end{itemize}
Отметим, что дифференциал \textit{"не понижает градус фильтрации"}, т. е.  $d(F^p K^n)\subset F^p K^{n+1}$.
...
\end{to_ex} 
\begin{to_ex}[Cпектральная последовательность канонически фильтрованного комплекса]
