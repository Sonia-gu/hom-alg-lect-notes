...
\end{to_suj}
\begin{proof}
Пусть $Q_\bullet \to M$ -- проективная резольвента. Рассмотрим снова двойной комплекс $(P_\bullet\otimes Q_\bullet)_{ij}$. Рассмотрим сначала вертикальные когомологии и воспользуемся тем, что $P$ -- плоская, а $Q$ -- проективная резольвенты:
\begin{align*}
