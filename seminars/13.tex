...
\begin{align*}
\mathbf{(1)} \quad& d^{-1}\left(Z_{r-1}^{p+r+1, q-r}+dZ_{r-1}^{p+1, q-1}\right) = d^{-1}\left(Z_{r-1}^{p+r+1, q-r}\right)+Z_{r-1}^{p+1, q-1}\\
\mathbf{(2)} \quad& Z_r^{pq}\bigcap \left(d^{-1}\left(Z_{r-1}^{p+r+1, q-r}\right)+Z_{r-1}^{p+1, q-1}\right) = Z_{r-1}^{p+1, q-1}+Z_r^{pq}\bigcap d^{-1}Z_{r-1}^{p+r+1, q-r}
\end{align*}
\[
