...
\bee
\begin{tikzcd}[sep=small]
\ldots \arrow[r]\arrow[d]& E^{-p-1} \arrow[r]\arrow[d]& \ker d^{-p}\arrow[r]\arrow[d]& 0 \arrow[r]\arrow[d]&0\ldots\\
\ldots \arrow[r]\arrow[d]& E^{-p-1} \arrow[r]\arrow[d]& E^{-p}\arrow[r]\arrow[d]& \ker d^{-p+1} \arrow[r]\arrow[d]&0\ldots\\
\ldots \arrow[r]\arrow[d]& E^{-p-1} \arrow[r]\arrow[d]& E^{-p}\arrow[r]\arrow[d]& \ker E^{-p+1} \arrow[r]\arrow[d]& \ker d^{-p+2}\ldots\\
		\ldots&		\ldots	&	\ldots		&\ldots &\\
\ldots \arrow[r]& E^{-p-1} \arrow[r]& E^{-p}\arrow[r]& E^{-p+1} \arrow[r]& \ldots
\end{tikzcd}
\eee
\end{itemize}
