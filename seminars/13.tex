...
\ldots \arrow[r]\arrow[d]& 0 \arrow[r]\arrow[d]& K^{n}\arrow[r]\arrow[d]& K^{n+1} \arrow[r] \arrow[d]&\ldots\\
\ldots \arrow[r]& K^{n-1} \arrow[r]& K^{n}\arrow[r]& K^{n+1} \arrow[r]&\ldots\\
\end{tikzcd}
\eee
...
\eee
\end{itemize}
Данные фильтрации являются убывающими, то есть $F^{p+1}K^\bullet \subset F^{p}K^\bullet$. Обычно также от фильтрации комплекса требуется, чтобы $d(F^p K^n)\subset F^p K^{n+1}$.\footnote{\textbf{filtration respects differentiall structure}}
...
%\bee
%\begin{tikzcd}[sep=small]
%               & F^2 & \ldots \arrow[r] & \ker d^{-2} \arrow[r] & 0 \arrow[r]           & 0     \\
%F^pK^\bullet : & F^1 & \ldots \arrow[r] & K^{-2} \arrow[r]      & \ker d^{-1} \arrow[r] & 0     \\
%               & F^0 & \ldots \arrow[r] & K^{-2} \arrow[r]      & K^{-1} \arrow[r]      & K^{0}
%\end{tikzcd}
%\eee
\bee
\begin{tikzcd}[sep=small]
          & \ldots \arrow[r] & B^{-2} \arrow[r] & Z^{-2} \arrow[r] & 0 \arrow[r]      & 0   \\
E_0^{pq}: & \ldots \arrow[r] & 0 \arrow[r]      & B^{-1} \arrow[r] & Z^{-1} \arrow[r] & 0   \\
          & \ldots \arrow[r] & 0 \arrow[r]      & 0 \arrow[r]      & B^0 \arrow[r]    & K^0
\end{tikzcd}
\qquad
\begin{tikzcd}[sep=small]
          & \ldots \arrow[r] & 0 \arrow[r] & H^{-2} \arrow[r] & 0 \arrow[r]      & 0   \\
E_1^{pq}: & \ldots \arrow[r] & 0 \arrow[r] & 0 \arrow[r]      & H^{-1} \arrow[r] & 0   \\
          & \ldots \arrow[r] & 0 \arrow[r] & 0 \arrow[r]      & 0 \arrow[r]      & H^0
\end{tikzcd}
\eee
\end{to_ex}
...
\begin{tikzcd}
\ldots	     & 0 & 0 & 0 &\\
    \ldots&\arrow[r]K^{0,-2}\arrow[u]& K^{0,-1}\arrow[r]\arrow[u]&K^{0,0}\arrow[r]\arrow[u]&0\\
    \ldots&\arrow[r]K^{-1,-2}\arrow[u]& K^{-1,-1}\arrow[r]\arrow[u]&K^{-1,0}\arrow[r]\arrow[u]&0\\
    \ldots	     & \ldots\arrow[u] & \ldots\arrow[u] &  \ldots\arrow[u] &
\end{tikzcd}
\eee
