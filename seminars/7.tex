...
\end{to_claim}
\begin{proof}
Строим резольвенту. На первом шаге вложим нулевой член в некоторый объект из класса $R$
\bee
\begin{tikzcd}
...
\end{align*}
\end{proof}
Продолжим построение производного функтора. Ранее было отмечено, что если $\F$ -- точный, то приспособленным классом являются все объекты нашей категории.\\
