...
\textit{Построение}. На этом шаге мы показываем \textbf{точность в смысле производной категории}.
     ...
     \\
\textbf{План:} %начиная отсюда нужно пересмотреть и дописать 
\begin{enumerate}
