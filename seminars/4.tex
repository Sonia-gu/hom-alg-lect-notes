...
\end{to_suj}
\begin{proof}
Имеем морфизм комплексов $f$ \begin{tikzcd}[sep=small] Q_\bullet  \arrow[r] & N[0] \end{tikzcd} и его конус \begin{tikzcd}[sep=small] Q_\bullet  \arrow[r] & N[0] \arrow[r] & C(f) \arrow[r] & Q_\bullet [1] \end{tikzcd}\\
\bee
...
\begin{center}
\begin{tikzcd}[sep=small]
\Hom(P_\bullet, N[-1]) \ar[r] &\Hom(P_\bullet, Q_\bullet) \ar[r, "\cong"] &\Hom(P_\bullet, N[0]) \ar[r] &\Hom(P_\bullet, C(f)) \ar[r] & \Hom(P_\bullet, N[1]) \ar[r] & ...\\
\cong 0 & & & \cong 0 & &
\end{tikzcd}
\end{center}
