...
\]
Таким образом может быть задана структура градуированной алгебры\footnote{градуированной некоммутативной $\Z_{\ge 0}$--алгебры при совпадающих аргументах, если не фиксировать аргумент, то алгебра градуирована целыми неотрицательными числами и парами объектов} $Ext_{R}^\bullet (A, A)$, $A\in R-mod $.\\
